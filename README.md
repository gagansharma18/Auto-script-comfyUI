...
*   [`SKILLS/stixx_stories_scriptwriter_skill.md`](SKILLS/stixx_stories_scriptwriter_skill.md): The copy-pasteable system prompt/instructions to turn any LLM into a Stixx Stories scriptwriter.
