...
| [`SKILLS/stixx_stories_scriptwriter_skill.md`](file:///C:/Users/gagan/Documents/YOUTUBE/Auto%20script%20comfyUI/SKILLS/stixx_stories_scriptwriter_skill.md) | **AI Prompt / System Instruction** | A copy-pasteable prompt and instruction template to turn any LLM (ChatGPT, Claude, Dify, etc.) into the Stixx Stories scriptwriter. |
